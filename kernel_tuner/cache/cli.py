...
We can:
   ...
   - `merge`: merge several (>=2) cache files that are of the same jsonschema and have equivalent metadata.
...
from .cli_functionality import convert, convert_t4, delete_line, get_line, merge
