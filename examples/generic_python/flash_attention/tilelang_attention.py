# example taken from https://github.com/tile-ai/tilelang/blob/main/examples/flash_attention/example_mha_fwd_bshd.py
import torch
...
def main(
    ...
    if not tune:
        ...
        # Changed block size so fits in shared mem
